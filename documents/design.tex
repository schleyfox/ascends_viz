...
It is also useful to be able to find the distance between two points.  This can be found using an adaptation of the Haversin Formula.
...
Going in the opposite direction, coordinates can be found 
